...
The tail index from Extreme Value Theory, estimated using the Hill estimator. Lower values mean fatter tails — more extreme events are possible than standard models assume. Equities typically sit around 3–5. Assets below 3 have meaningfully fatter tails. Bitcoin and Gold often come in below 3.
